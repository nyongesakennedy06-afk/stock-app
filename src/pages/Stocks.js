                        ...
                        <div className= "stock-column-data">
                            {
                                summary ? (
                                    <>
                             <h2><span style = {{color: "black" }}><span className = 'summary-span'>{summary.exhangeName} ({summary.symbol})</span> ${summary.regularMarketPrice}</span></h2>
                                 <div className='stock-headings'>
                                            ...
                                            <hr /><br />
                                            <h4><span className='summary-span'>Previos Close Price:</span><span style = {{ color: "black" }}> {" "} {summary.chartPreviosClose}</span></h4>
                                            <hr /><br />
